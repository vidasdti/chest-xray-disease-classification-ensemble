...
# =====================================================
# Step 1: Compute per-class accuracy on VALIDATION
# =====================================================
...
for i,c in enumerate(CLASSES):
    print(f"{c}: ConvNeXt={weights[i]['convnext']:.3f}, ResNet={weights[i]['resnet']:.3f}")

# =====================================================
# Step 2: Test-time Fusion
# =====================================================
y_true, y_pred = [], []
...
print("\n VALIDATION-WEIGHTED SOFT FUSION")
